...
public class StudentListItemTest {
    ...
    public void mainTest() {
        ...
        StudentListItem a = new StudentListItem(123, "martin", IMAGE);
        a.createView(inflater, layout, act);

        a = new StudentListItem(123, "martin", null);
        a.createView(inflater, layout, act);
    }
}
