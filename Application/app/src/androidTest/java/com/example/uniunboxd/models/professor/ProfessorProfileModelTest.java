...
public class ProfessorProfileModelTest {
    ...
    public void mainTest() {
        ...
        ProfessorProfileModel a = new ProfessorProfileModel(123, IMAGE, "Algo", "tue", new ArrayList<>());
        a.createView(inflater, layout, f);

        AssignedCourseModel ac = new AssignedCourseModel(123, 4.1f, 4.2f, "Algo", "22222", "tue", IMAGE);
        a = new ProfessorProfileModel(123, null, "Algo", "tue", List.of(ac));
        a.createView(inflater, layout, f);
    }
}
