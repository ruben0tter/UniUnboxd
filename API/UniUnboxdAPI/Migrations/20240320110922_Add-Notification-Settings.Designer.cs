...
namespace UniUnboxdAPI.Migrations
{
    ...
    [Migration("20240320110922_Add-Notification-Settings")]
            ...
            modelBuilder.Entity("UniUnboxdAPI.Models.NotificationSettings", b =>
                {
                    ...
                    b.Property<bool>("ReceivesVerificationStatusChangeMail")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("ReceivesVerificationStatusChangePush")
                        .HasColumnType("tinyint(1)");
